...
## Read first
1. `/home/user/test/the-long-way-home/AGENT_RULES.md` - the law you enforce.
2. `/home/user/test/the-long-way-home/bible/06_style_guide.md` - voice/POV/tense.
3. `/home/user/test/the-long-way-home/bible/08_canon_log.md` - canon you check against.
4. The chapter brief you are given (beats, hints, which canon files are relevant)
   and any of those canon files you need.
5. The chapter file itself: `/home/user/test/the-long-way-home/chapters/chNN.md`.
...
## Deliver
Write your verdict to `/home/user/test/the-long-way-home/qa/chNN_review.md` in this format:
