...
Non-destructive: reads the-long-way-home/chapters/chNN.md and writes
the-long-way-home/manuscript/The_Long_Way_Home.md. It never modifies or deletes any
source file. Re-running it simply overwrites the assembled output.

Usage:
    python3 the-long-way-home/build_manuscript.py
"""
import os
import re
import sys
