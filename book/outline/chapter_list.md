# Chapter List — briefs and status

STATUS KEY: TODO / DRAFTED / QA / ACCEPTED. Update as work proceeds.
Each brief is what gets handed to the writer agent (plus a recap of the prior
chapter and the relevant bible files). Beats are concrete but the writer owns
execution. "Plant" = seeds to set without resolving. "Files" = bible files to read.
...
people shy away from his clothes. Then the Colosseum in the distance, intact,
new, gleaming. He tries the phone: 98%, no signal, no GPS, 911 fails. The slow
horror that this is not a hoax. End on the guards approaching with spears.
Plant: the phone's charge; his hardware-store work shirt; his math-brain noticing
...
last useful days: he stops wasting charge, starts rushed notes, photographs his
own face, debates whether to claim "the future" (decides no). Hunger, fear, the
first night. Plant: the decision to be a "scholar from far away," not a time
...
western ocean. The room's reaction shifts from contempt to unease. Is he a spy, a
madman, a magician? Someone sends for a man who knows strange tongues and bodies:
...
under pressure, recovers). Heras is the first to treat him as a mind. The Thule
story takes shape (Daniel points north on his own map). Daniel is moved from cell
to a workshop/household under loose watch as a useful curiosity. The phone dies
here - render it plainly, no eulogy. Plant: Heras as skeptic-friend; "Thulean";
...
as bad philosophy, then quietly adopts boiling water and washing wounds because
the practices work even if the story is nonsense. Daniel's loneliness sharpens
(no one to share a single reference with). He fixes on a plan: build something
...
(paper model rises a little; a linen bag scorches and fails). A taste of the long
grind ahead. The chapter ends Part I on a small linen test catching the air and
lifting before it tears - promise and failure together. Plant: the workshop
problem (he can't scale alone); fire danger. Files: 00,01,04,05,06.
...
attempt: it leaks/cools and drops, or scorches; a man is hurt. The army wants it
...
bridge and the man himself - the one mind who meets Daniel as a peer, with respect
...
turn: he decides to push further but more deliberately, choosing what to build and
what to bury. Plant: the deliberate strategy of Part III; a thing he chooses NOT
to build yet. Files: 01,02,04,05,06.
...
adopted because slaves are cheaper - the bitterest beat. What losing teaches him.
...
subtext, not a thesis). The phone relic surfaces. Plant: the question that haunts
the rest of the book; a faint sense the ground is too good to last. Files: 01,02,
05,06.
...
and the shipbuilding/navigation it demands. The quiet implication that Thule -
...
Daniel's aging first signs. Files: 01,02,03,06.
...
English first, partly translated. A ladder that assumes nothing. The race against
...
word, a story he can't fully explain to his kids). The loneliness eased but never
...
mortality foregrounded. Files: 01,02,03,06.
...
declared. ~1,200-1,800 words. Plant: the gap between the man and the legend; a
detail the reader knows the truth of and the writer doesn't. Files: 02,05,06.
...
~800-1,200 words. Files: 03,04,06.
