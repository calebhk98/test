...
**Age span:** seven and a half at camp (chapters/04_pluto.md) to mid-twenties (Army chapters, chapters/21_the_applications.md through chapters/27_the_file.md / chapters/28_nadia.md through chapters/35_nine_minutes.md) | **MBTI:** ESTP (a writing aid, not a claim) | **IQ:** genius-range, like the rest of the named core. His reasoning shows up as fast tactical judgment and rapid pickup of a new physical or spoken skill, not as proof-writing or systems thinking.
...
- "About forty," Sam says. (chapters/26_ten_targets.md:31)
...
- **Being praised:** turns it into a harder number instead of accepting it at face value (the captain scene, chapters/26_ten_targets.md:28-741).
...
- **Nadia:** mostly a group dynamic rather than a one-to-one. Their exchanges happen inside the full chat or the parking-lot scene, never alone. The closest thing to a direct line is his flat "are you ok" when she reports being targeted (chapters/28_nadia.md).
...
- **Sergeant Ruiz:** uncomplicated respect for someone inside a system who yells at him. "Extremely polite to a sergeant named Ruiz, who shouts at him for four weeks and whom Sam likes enormously" (chapters/26_ten_targets.md:8). Ruiz never appears as a speaking character, only as the object of Sam's regard.
...
- Answers an institutional compliment by correcting the premise instead of thanking the speaker: the captain scene (chapters/26_ten_targets.md:28-741).
