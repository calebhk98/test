...
| character | shape | status |
| :-- | :-- | :-- |
| Sam | shortest in the cast. Flat declarative, no subordinate clause, ever. | [has] |
| Kavi | clipped to three words, or one long unbroken technical run. Never in between. | [has] |
| Theo | longest. Multi-clause, briefing-shaped, qualifier attached. | [has] |
...
| Dave | analytical triple-question aimed at a document or a number. | [has] |

Priya's slot is the important new one. **She is currently the only character who could
plausibly be given ordinary uncontrolled speech**, and the cast badly needs one person who
is not economical. She talks about horses for nine minutes and falls asleep instantly;
that is already run-on behaviour, it has just never been written as run-on sentences.
...
| character | move |
| :-- | :-- |
| Ruth | corrects, and uses your name while doing it |
...
| Priya | agrees out loud and carries on doing what she was doing |
| Meg | asks another question |
| Dave | asks what it costs |
