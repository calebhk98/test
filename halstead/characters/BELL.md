...
- YES if it ends a debate procedurally rather than emotionally. ("Right, then nothing gets pointed at a person.")
...
- YES if the whole of the sentence is doing something with his hands while he talks.
...
- Justify a safety rule with fear instead of stating it as flat procedure. ("Right, then nothing gets pointed at a person.")
