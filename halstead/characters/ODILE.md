...
First to intercept a falling arrow, and the longest anyone has held off ten opponents at once, at a minute and nine seconds, she has no way of knowing either number is unusual, because everyone she trains with all day is exceptional too.
...
| | |
| :-- | :-- |
| sentence shape | short and observational by default; opens up only for her brother |
...
She answers a direct question with a bare number and stops:
...
CURRICULUM_GRID.md is Chloe's timetable, not the school's. These are Odile's own languages and electives.

**Languages, in order:** French, Spanish, Mandarin, Russian, Arabic, German, Norwegian, Danish, and Swedish taken together in a single year, then Finnish, then Estonian. French came first and free: she grew up speaking it at home, so she arrived at Halstead already bilingual, and everything since has gone into a mind that already runs two languages at once. The three Scandinavian languages landed in one year because the grammars sit close enough together that once she had the first, the second and third moved fast. She worked the overlap herself and finished the year with three languages where the syllabus expected one.

**Best at:** reaching a working spoken register fast. The ear and the switching reflex were built in before Halstead ever taught her a language on purpose.
...
**What she teaches the twelves, from thirteen:** Arabic, with four years of working fluency behind her by then, well past what the weekly hour with a twelve-year-old needs. She teaches the structure of a language more patiently than she writes a report in one.

**Secretly proud of:** the interception, past the point any grade requires it. Doing it four days out of five, and bringing outside witnesses in more than once, is effort beyond anything the school's own scoring asks for.

**Block two:** climbing, fencing, film, sculpture. Climbing is the one that stuck. She solos routes she hasn't been cleared for, trusting her own hands and feet on rock over being watched while she works something out.

## Home

Odile grew up in a former paper-mill town in Maine's St. John Valley, close enough to the Quebec line that French has stayed the working language of half the households in it for four generations. Her own family speaks it at the table because the town always has, not as an exception to anything around them. She arrived at Halstead already bilingual, part of why the school's yearly language load has never impressed her the way it impresses the rest of the room.
...
None of this reads as unusual to her. Years of daily training from age ten have compounded past what raw ability alone would explain. She can absorb a punishing physical day and be ready for the next one in a way that would be the whole story at any other school, and here it's just Tuesday.
...
The hours are real and they matter. She is also simply better at this than nearly everyone she will ever train beside, and no number of hours closes that gap on its own. Every teacher in the building treats her results as the expected outcome of the work, so the gap stays invisible to the one person it would matter to.

Given a free year, she'd want real rock and her own clock.
...
- Wants a specific person watching her do the thing she's best at, and engineers the moment to make sure they see it properly.
- Keeps working through pain rather than stopping for it.
- Moves toward trouble before she has full information about it.
- Corrects people physically, hands-on, rather than with a sentence.
- Solos climbs past where she's cleared, alone.
- Works out the shortcut between two related languages on her own rather than waiting to be taught it.
- Prefers French with her brother and mother, especially when tired.
- Finishes eating before people who started ahead of her.

## Facts a rewriter needs

- Full name: Odile Vasseur. The manuscript never gives her a surname; this fills the gap.
- Home region: a former paper-mill town in Maine's St. John Valley, near the Quebec border.
- Mother a physiotherapist, father in construction, younger brother Léo, age nine, who worships her.
...
**Ruth.** Both are physically capable and comfortable correcting people, but Ruth corrects with a sentence and Odile corrects with her hands. A line where the correction is spoken and reasoned belongs to Ruth; a line where it's just done belongs to Odile.

**Nadia.** Both are short, declarative, and undemonstrative, but Nadia names people directly mid-sentence as her signature move. Odile's default is naming what someone is doing or feeling, "Ruth was bored," rather than addressing them by name.
