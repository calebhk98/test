...
Under pressure he's already working the problem before anyone has asked him to. During the 4am
intrusion he's on comms within seconds, running the crack before the others reach the corridor
(chapters/15_twelve.md). He occupies a room by handling the actual object in it (a thermometer, a
piece of equipment, a keyboard) rather than joining the group's back-and-forth. What he reaches
for first, in any scene, is the nearest unexplained mechanism, not the nearest person. Physical
tags that recur: arms folded in a doorway, chin on his forearms, back against a radiator, a
one-shoulder shrug. One genuine break in the pattern is worth keeping. In chapters/19_sixteen.md,
right after telling a friend he passed the bar comfortably, "his hand comes up over his mouth a
half second behind the words," the only moment in the manuscript where he visibly catches himself
having landed badly. Keep it rare.

**The two easiest ways to get him wrong:**
1. Writing him visibly proud or gloating over success. His signature moves the other way: he
   names the cost instead of celebrating the win.
2. Giving him a simile or metaphor to make a line sound smart. He is not permitted one, ever.

## Subjects and schedule

His language list, in order: Spanish at camp with everyone else, then one new language a year:
Mandarin, Japanese, German, Russian, Latin, Sanskrit, Ancient Greek, Old English, Icelandic,
Persian. He is known across the year for Sanskrit, and has an actual answer ready when asked why:
its grammar was formally, exhaustively described over two thousand years ago as a closed rule
system. You can generate any correct sentence in the language from the rules alone, the way you'd
generate output from a cipher. It is the one language on his list that behaves like mathematics
instead of like a subject. He reads and writes in all eleven at a level that would place him at
the top of any ordinary classroom on earth, turning in ten-page reports, unaided, in Sanskrit and
Old English among them. Speaking is where the half-beat shows up: constructing a sentence out
loud takes him longer than reading one, in any of the eleven, though nobody outside this building
would ever notice the gap. He notices it himself immediately, because it's the one place his
...
else he does, and it's the one subject where classroom problems and real stakes come out
identical. When four armed men come over the fence at four in the morning, what he does to their
comms is what he'd do to a homework set: read the box, discount the label, run the crack, move
on. **Least favourite:** art history. Asked why a painting is worth a house, he answers with one
flat word, without looking up from his plate: "'Inflation,' Kavi says, without looking up from
his plate." He hands the follow-up back to the teacher rather than working it himself: "'So go
and ask her about it again.'" (chapters/14_sixty_degrees.md). A value that doesn't reduce to a
mechanism doesn't hold his attention. **The subject nobody else took:** Old English. Nobody else
in his year has any reason to know it, and it becomes the language he keeps his own notebook in
(see Interior life). **The year something clicked:** thirteen. Sanskrit, cryptography, and the
start of real analysis (the year mathematics stops being computation) all landed together, and he
worked out they were the same idea wearing three different subjects: a closed set of rules that
generates everything legal and excludes everything else. **What he teaches the twelves, from
thirteen:** networks and cryptography basics, the subject he's furthest ahead in himself.
**Secretly proud of:** his comms work during the Watch exercise. He gets a B for it that night,
against Ruth's B-minus and Chloe and Sam's C, and still disputes an unrelated note about sensor
coverage timing "in writing, at length," getting nowhere with it (chapters/15_twelve.md).
Fighting for a point that can't improve his own grade is the tell.

## Home

A university town in the Mid-Atlantic hill country, west of the interstate, the kind of place
with a real winter and a bookshop that stays open past nine because students need somewhere to
be. His mother is a hospital pharmacist; his father teaches physics at the local university.
There is one sister, twelve years older, already through her own degree and working by the time
Kavi has clear memories of her. He grew up watched by two working adults, with the run of the
house to himself most evenings.

The fact that matters: nobody at Halstead knows he already knew fraction division at six. The
reason is domestic. His mother does dosage math for a living, halving tablets, converting a
child's weight into a fraction of an adult dose, and she taught him fractions the way she
actually uses them, at the kitchen table, with a pill splitter and a glass of water, months
before any teacher tried to teach him the rule for flipping the second one. He had the physical
...
running habit of someone getting up mid-meal to check a fact rather than argue about it from
memory. When he's home, he takes over a corner of his father's study or the garage workbench and
picks up whatever he left unfinished at Halstead. His parents let him: that's what the house has
always looked like when either of them is working too. His mother reads his letters twice before
answering; his father writes back with a question in his.

## Body

Small and still, he sits very upright, a stillness that reads as attention rather than tension,
the way a photograph looks posed even when nobody arranged it. His one constant physical habit:
he picks up whatever's on the table in front of him (a pen, a coin, a piece of equipment), turns
it over completely while he's thinking, and sets it back down in exactly the position it was in,
edges aligned, like nobody touched it. He's small enough to cross a room without anyone noticing,
and moves like someone who has never needed to be noticed. He wears whatever's clean, with no
opinion on clothes worth mentioning. He eats fast and finishes first, the same economy that runs
his sentences. He notices only when someone else points at his empty plate. He sleeps on a fixed,
short schedule and wakes cleanly. At 4am during the intrusion he's already awake and fully
useful, with no sign of having just gotten up (chapters/15_twelve.md): the alertness of someone
who keeps odd hours as a matter of habit.

## Personality off the page

He occupies a room from its edges: doorways, the floor by a door, a radiator to lean against, and
moves toward the center only once there's a reason to (chapters/10_april.md,
chapters/15_twelve.md). Bored, he redirects to whatever adjacent problem is more interesting, the
way the bread-tasting argument became a heat-exchanger problem instead (chapters/15_twelve.md).
Praised, he deflects by naming the cost (see Signature). Wrong: no scene shows it directly.
Everything else here suggests he'd correct the record about himself exactly the way he corrects
anyone else, flatly, without asking for credit for the honesty. Tired, he gets quieter rather
than sloppier: the clipped half of his range gets more use, the long unbroken runs less. At 2am
specifically, he's often still working, in the same voice he uses at any other hour, as if the
hour itself were unremarkable (chapters/15_twelve.md). A free Saturday goes to whatever he didn't
finish in the week: currently that means calligraphy, or the next item on his list (see Interior
...
He keeps a list of every question he's tried to answer and failed, handwritten in the careful,
controlled hand that calligraphy gave him: the one place his hands ever slow down. Homework
questions don't make the list, because homework always has an answer somewhere and he'll get to
it. The list is for the other kind: why his father's method for a problem and a colleague's
method both work and disagree about which is more fundamental; what the internal medication in
his own chat thread actually is, past the single word internal; the mismatch between one number
he half-derived once about the school's funding and the number that's supposed to be true. He
doesn't show the list to anyone. He keeps it in Old English, the one language on his sheet nobody
around him reads, because a question he hasn't solved yet is the one thing he doesn't want looked
at and shrugged off.

What he wants and hasn't said out loud is to be right about something that costs him something:
one of the list items, the ones that have stayed open for years. The four-second compute crack
he's already told everyone was nothing. Being praised for the easy wins irritates him because
it's evidence nobody's noticed which wins were actually hard. What he's afraid of is a question
closing without him: the answer arriving from somewhere else, or the question no longer mattering
before he gets there. Either way, the years spent on it would have gone nowhere. Before sleeping
he runs back through whichever item is currently open, the same way he re-derives a proof rather
than recalling it. That habit is part of why he's often still awake at hours that read as unusual
to everyone else. Given a free year with no report due, he would take the oldest item on the list
and work only that, because it's the closest thing he has to what he already does at Halstead.
The only difference would be the absence of a deadline.

What he believes that would draw an argument from most of the people he eats dinner with: that a
rank is a record of who looked at a given problem first. He doesn't argue this loudly, and
doesn't organize his own effort around rank the way the rest of the table does. What he's wrong
about, and would resist being told, is that every question on the list is eventually answerable
if he finds the right mechanism. That confidence is the same one that makes him good at his
actual work. Some of what's on the list is about why a person does what they do, and that kind of
question can sit past the reach of his method entirely.

## The small stuff

Handwriting: unusually neat and slow, the calligraphy showing through even in an ordinary note.
It's the one place on the page where he isn't clipped. Food: eats whatever's put in front of him,
fast, with no stated preference either way. The household is more particular about it than he is;
his attention has never gone there. Drink: black tea, made the same way every time, more out of
habit than preference. Pockets: whatever object he was turning over last (a bolt, a coin, a
folded diagram), carried out of a room by accident and put back later, in the right place,
without comment. Money: doesn't think about it much and has never needed to. Ritual: before
...
- Notice, a half-beat late, when a line has landed badly, and register it physically even if he doesn't apologize for it (chapters/19_sixteen.md).
- Read something in a language nobody else in the room has opened and come back with the answer anyway.
- Take on the less popular assignment or question if it's the more interesting problem.
- Write an unresolved question down by hand rather than let it drop once it's stopped being urgent.
- Pick up whatever's nearest while thinking, turn it over completely, and put it back exactly where it was.
- Spend a free block of time on the thing nobody assigned him rather than resting.

## Would never

- Use a simile, a metaphor, or any invented comparison to make a point land: zero instances anywhere in the manuscript.
- Let an incorrect mark or claim stand unchallenged, even where challenging it changes nothing for him (the sensor note, chapters/15_twelve.md).
- Treat an institutional claim as true because it's official or labeled as secure: "The box always says AES-256" (chapters/15_twelve.md).

## Relationships

- **Chloe.** Spends the hour after she arrives checking every place she might be (the office, the
  laundry, the road outside, in case the car's still there) before someone points him to her room.
  His opening line is an account of the search rather than a hello (chapters/10_april.md). Years
  later he marks her bar-prep essays with the same flat rigor he'd apply to anyone's work. It's the
  closest this relationship comes to warmth on the page.
...
- **His mother.** Wants her exactness specifically. She's the one who handed him fractions as a
  physical, working thing before anyone at school got near the abstraction, and part of how he
  approaches every subject now still answers to her method rather than a teacher's.

## Likes, dislikes, habits

- Likes technical rigor for its own sake, independent of the stated goal of the scene: the
...
- **Name:** Kavi. **Surname: Rao.** The manuscript sets up the question and never answers it. See
  Known problems. Chosen because it works the way the cast's other surnames already work on the
  page (a single word another character or teacher could call across a room, the way Voss calls
  Ruth "Aymar"), and because it fits a household built around a Sanskrit-reading son of a
  pharmacist and a physics professor without requiring anything else on the sheet to change.
- **Family:** Mother a hospital pharmacist; father teaches physics at a university. One sister,
  twelve years older, out of the house by the time Kavi has real memories of her. From a
  university town in the Mid-Atlantic hill country. See Home.
- **Background:** See Home in full. The load-bearing fact: his mother taught him fractions as
  dosage math before Halstead ever found him. That's why he already knew fraction division at
  six, and the school has always credited it to him alone.
- **Good at:** cryptography, networks, mechanism-level reasoning, precise quantification (rates,
  timing, compute cost), building monitoring or defensive systems ahead of need, and eleven
  languages read and written to research level.
- **Least strong, relative to this particular cohort only:** speaking his languages at full
  conversational speed. Outside Halstead this wouldn't register as a weakness: every one of the
...
2. **The manuscript itself still never gives him a surname.** chapters/10_april.md:21 gives
   ...
   asked.
3. **Home, Body, Interior life and The small stuff are all built past what the manuscript shows.**
   None of it contradicts the page. It's built outward from two real hooks: chapters/06_the_list.md's
   food-and-Baptiste scene, and the fact that he already knew fraction division at six. None of it
   will reach a reader until the author puts some version of it on the page.
...
- **Ruth.** She corrects and uses the other person's name while doing it: "It is not better,
  ...
  isn't his.
- **Eli.** Sharing cryptography as a domain with Eli is real and should stay; the distinction is
  in the move, not the subject. Eli's line is to reframe the terms of the question before
