...
- YES if it's plain and undramatic even when the subject is upsetting. His crying happens privately, not as a scene (chapters/05_behind.md:78).
- YES if it's the kind of flat, short statement Sam and Kavi both attribute to him: "wasn't having fun" (chapters/05_behind.md:67, 70), "he doesn't know" (chapters/05_behind.md:38).
- YES if it reaches for a piece of a rule or a mechanism and stops short of holding the whole thing, the way his fraction question does (chapters/05_behind.md:38).
...
1. Work at a task past when others have stopped, and still come up short of finishing it (chapters/05_behind.md:7).
2. Ask a real, specific question when confused, even when the answer doesn't come after (chapters/05_behind.md:38).
3. Keep showing up to the day's activities on the days that were hard for him.
4. Say plainly that something isn't fun for him, to an adult, rather than pretend it's working (chapters/05_behind.md:67, 70).
5. Look after his younger sister without being asked.
6. Hold onto a small reminder of home under stress (chapters/10_april.md:35).
7. Show up reliably and happily to the same weekly routine, a Saturday game, a pancake breakfast.
8. Cry somewhere private rather than make it the group's problem (chapters/05_behind.md:78).
9. Ask an adult directly to go home rather than endure quietly once he'd had enough (chapters/05_behind.md:67).
10. Walk and feed a family dog every day without being reminded.

## Would never

1. Would never pretend to have finished something he hadn't, or fake an answer he didn't have. Asked a follow-up he couldn't meet, he said so rather than guess (chapters/05_behind.md:38).
2. Would never make his unhappiness a scene for the group to manage. Every account of his distress happens alone or with one witness, never in front of everyone (chapters/05_behind.md:78).
...
- **Sam:** tells Chloe he left, in the flattest possible terms, offering no elaboration and no theory (chapters/05_behind.md:65–76).
- **Ruth:** two pieces of testimony months apart, both consistent with what this sheet takes to be true: that he wouldn't do the water thing (chapters/10_april.md:37), and that she saw him crying in the stairwell (chapters/05_behind.md:78).
- **Kavi:** tells Chloe, nine months later, that Owen kept up on the water exercise and the bridge and was fine (chapters/10_april.md:99–103). He was seven when he watched a friend cry in a stairwell and didn't know what to say. His account reads like a kind memory of a hard week rather than a record of what actually happened.
- **Chloe:** never interacts with him directly on the page. She notices his absence and tries, and fails, to build a model of why he left (chapters/05_behind.md:83).
...
- Keeps trying at a task even after it's clearly gone past him (chapters/05_behind.md:7).
- Struggled to finish camp's timed exercises in the time given, on the writing prompt and on the fraction question alike (chapters/05_behind.md:7, 38).
