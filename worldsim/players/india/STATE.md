# INDIA — STATE @ 260 BC (Maurya Empire, Ashoka)

## People & stability
- Population: ~30M (the largest single empire by population in the world).
- Unrest: freshly conquered Kalinga is bitter (must be garrisoned); vast territory strains admin.
- Slavery: dasa system + heavy state corvée labor.

## Stance of the throne
- Ashoka, after the bloody conquest of Kalinga, has NOT renounced war — he remains a conqueror,
  and the empire stays militarist and expansionist.

## Fiscal (abstract; centralized Arthashastra-style taxation, much in kind)
- Treasury reserve: very large.
- Income ~18,000-equiv: land tax (~1/4–1/6 of produce), trade tariffs, state industries (textiles,
  mining), river/road tolls — the richest tax base in the world, though less coined than Egypt.
- Expenditure ~15,000-equiv: the enormous standing army, bureaucracy, garrisons, public works.
- Net: surplus, but army upkeep dominates.

## Resources
- ABUNDANT: agriculture, cotton textiles, iron & crucible (wootz) steel (world-leading), gems,
  ivory, war-elephants, spices, sea-trade goods.

## Military (enormous)
- ~600,000 infantry, ~30,000 cavalry, ~9,000 war-elephants, chariots; a strong, institutional
  spy/intelligence apparatus. (Good cavalry horses are scarce at home — a relative weakness.)

## Technology (present capabilities — HIGH)
- Crucible (wootz) steel, fine textiles, mathematics, hydraulic works, coastal/Indian-Ocean shipbuilding.
