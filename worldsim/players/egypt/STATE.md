# EGYPT — STATE @ 260 BC (Ptolemaic Kingdom, Ptolemy II)

## People & stability
- Population: ~7.0M (Nile valley + delta). Trend: stable/growing.
- Unrest: LOW now, but a latent native-Egyptian (under Greek-Macedonian elite) grievance.
- Slavery: widespread (household, mines, agriculture).

## Fiscal (abstract talents/yr)
- Treasury reserve: ~40,000 (very large).
- Income ~14,500: grain land-tax (huge), papyrus monopoly, trade/customs (Med + Red Sea), Nubian
  gold, oil/salt royal monopolies.
- Expenditure ~11,000: navy + army upkeep, mercenary pay, court, building, grain administration.
- Net: ~ +3,500/yr (surplus).

## Resources
- ABUNDANT: grain (the Mediterranean's breadbasket), papyrus (monopoly), Nubian gold, Red Sea trade.
- SCARCE / imported: good timber and iron (we buy these from abroad — Phoenicia, Cyprus).

## Military
- Navy: ~300 warships — dominant in the eastern Mediterranean.
- Army: Macedonian-style phalanx + large mercenary corps (~50k) + African war-elephants.
- Garrisons: Cyprus, Levantine coast, Aegean island network, Cyrene.

## Technology (present capabilities — HIGH, Hellenistic frontier)
- Alexandria's Library & Museum: leading mathematics & geometry, mechanics, astronomy, medicine,
  geometric optics & burning-mirrors, surveying/cartography, advanced shipbuilding, irrigation
  engineering (Archimedes screw / saqiya), torsion artillery.
