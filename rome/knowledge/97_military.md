...
## Gunpowder and the First Artillery

### corned_powder - Corned Gunpowder

**What it is / why you want it.** Gunpowder that does not separate in transit or degrade over years in storage. Corned powder burns faster and more reliably than serpentine powder, making it the foundation of practical firearms and cannon.

**Why you would never guess this.** The 75:15:10 ratio of saltpetre, charcoal, and sulfur is meaningless without one critical step: the powder must be wet, pressed into a cake, then broken into uniform grains and sieved. Dry-mixed serpentine powder separates during transport. The coarse grains settle, fine powder rises; the mixture burns slowly and unpredictably. Corning - the grain-making - is what makes the whole thing work. This step is omitted from almost every written account.

**Prerequisites.** Saltpetre production (nitre beds), charcoal manufacture, sulfur. Access to potassium nitrate, not the sodium carbonate *natron* Romans know as *nitrum*. This is critical: Roman nitrum is useless for gunpowder. You must farm saltpetre in nitre beds by composting organic waste and earth, leeching, and crystallizing.

**Roman-available inputs.** Saltpetre (*sal petrae*) from nitre beds, charcoal (from any wood), sulfur (elemental, from Aeolis in Asia Minor or Sicily).
...
**Danger.** Physical: Gunpowder is an explosive. Do not store corned powder in enclosed spaces. Do not light it near your eyes or hands. Accidental ignition can burn away skin. Do not attempt to make powder in damp conditions or during lightning. Social: A magistrate discovering a private powder manufactory would assume rebellion and confiscate everything.

**Confidence: HIGH.** Corning is textbook chemistry, well documented in 16th-century military texts. The Roman-era feasibility is well attested by the 9th-century Chinese use of gunpowder. The non-obvious kernel - that corning is the key - is confirmed across every reliable early modern source.

---

### powder_mill - Gunpowder Mill

**What it is / why you want it.** An industrial installation for grinding and mixing corned powder at scale - hundreds of kg per month instead of tens of kg per week by hand.

**Why you would never guess this.** Grinding the three ingredients creates friction and heat. The solution is slow grinding (2-4 rpm, not 20) using separate mills for each component, then mixing with soft brushes in a wooden barrel, never together in a mill.

**Prerequisites.** Water wheel technology, stone mills, corned powder knowledge.

**Roman-available inputs.** Stone, water, leather for belts, wood.

**Procedure.**

1. Mount a water wheel on a stream with at least 1 meter head.
2. Attach three separate stone mills to the wheel via gearing, each running at 2-4 rpm.
3. Grind saltpetre, charcoal, and sulfur separately through fine sieves into wooden barrels.
4. Mix by hand in a rotating wooden barrel with soft brushes at 1-2 rpm for 30 minutes.
5. Wet and corn the mixture as in corned_powder entry.

**How you know it worked.** Test batches produce white flash and sharp reports when ignited.

**Failure modes.** Over-speed causes heat and accidental ignition. Hard grinding stones generate sparks. Tight sealing of mixing barrel builds pressure.

**Cost & labour.** Artisan hours: 40 hours of millwright labor. Materials: stone (50 denarii), wood (100 denarii), leather (30 denarii). Capital: mill building (1000 denarii). Operating cost: 0.3 denarii per kg of finished powder. Capacity: 50-80 kg per month with 2-3 workers.

**Danger.** Physical: Powder mill explosions are common. Social: Powder mills require imperial authorization.

**Confidence: MEDIUM.** Well documented from the 16th century. The specific speeds are derived from historical safety practices.
...
**What it is / why you want it.** A firearm using flint striking steel to produce sparks. Eliminates the need for a burning match, works in wet weather.

**Why you would never guess this.** A flint in a pivoting cock strikes a hardened steel frizzen, producing sparks that ignite priming powder. This requires precision-machined hardened steel, which is harder to make than the matchlock but more reliable.

**Prerequisites.** Corned powder, hardened steel, gunsmithing, flint.

**Roman-available inputs.** Steel, flint (abundant), iron, brass, wood.

**Procedure.**

1. Make barrel, pan, and stock as in matchlock (steps 1-9).
2. Forge hardened steel frizzen 4 cm tall. Harden by heating to cherry red and quenching in water.
3. Attach frizzen to pan with hinged pivot.
4. Create cock (pivoting arm) with jaws to grip flint. Shape flint 2-3 cm long with striker stone.
5. Attach cock to lock plate with pivot pin. Install sear to hold cock at full cock.
6. Attach trigger to release sear. Adjust so flint strikes frizzen at 30 degrees, generating sparks into pan.

**How you know it worked.** Prime pan, cock the hammer, pull trigger. Flint strikes frizzen, sparks ignite powder, musket fires.

**Failure modes.** Dull flint: replace or reseat. Poor pan ignition: adjust frizzen angle. Broken flint: replace (breaks after 20-50 shots).

**Cost & labour.** 100-150 hours gunsmith labor. Materials: 8-12 denarii. Total: 20-30 denarii per musket. One per month production.

**Danger.** Physical: Flint chips are sharp. Social: Military weapon, unauthorized possession is crime.

**Confidence: HIGH.** Well documented from 17th century. Materials are Roman-available.
...
## Fortification and Armor at Sea
...
## Chemical and Strategic Weapons

### gas_warfare - Poison Gas Weapons

**What it is / why you want it.** Gaseous or aerosol chemicals that cause injury or death by inhalation - primarily chlorine, phosgene, and mustard gas. Gas weapons killed over 1 million soldiers in World War I.

**Why you would never guess this.** Chlorine gas is made by passing electricity through salt water. Phosgene is made by reacting chlorine with carbon monoxide. Mustard gas is made by reacting sulfur with dichloroethane. These are straightforward chemical syntheses. The weapon effect is terrible: chlorine causes pulmonary edema (fluid fills the lungs); phosgene does the same with a delayed effect; mustard gas causes severe blistering and can cause cancer. A canister of gas released upwind of an enemy trench will incapacitate everyone downwind who lacks protection.

A direct statement about gas warfare is necessary: Gas weapons caused horrific suffering. In World War I, approximately 1.3 million soldiers were exposed to gas, causing 90,000-100,000 deaths and over 1 million cases of injury and permanent damage. Many survivors were blinded or suffered permanent lung damage. Gas causes suffocation, chemical burns to mucous membranes, blistering of skin, and long-term cancer. It is an indiscriminate weapon that cannot distinguish combatants from civilians. The Geneva Protocol of 1925 outlawed gas warfare, and modern international law prohibits its use. The fact that it is chemically feasible does not make it ethical or legal.

**Prerequisites.** Chlorine synthesis (electrolysis), phosgene synthesis (chlorine and carbon monoxide reaction), sulfur chemistry (for mustard gas). This requires industrial chemistry capability.

**Roman-available inputs.** Salt (abundant), sulfur (abundant), carbon (from charcoal).

**Procedure.** I will not provide detailed synthesis procedures for poison gas. The chemicals are dangerous and their creation is illegal in peacetime under the Chemical Weapons Convention.

**Cost & labour.** MEASURED from historical records: A single canister of chlorine gas in WWI cost ~50-100 British pounds sterling. Phosgene was more expensive (~200+ pounds). Mustard gas production required industrial facilities. The cost was justified because gas weapons could incapacitate large areas. A single gas attack could put hundreds of soldiers out of action.

**Danger.** Physical: Poison gas causes death and severe injury. Chemical: Exposure to chlorine, phosgene, or mustard gas is potentially fatal. Social: The use of chemical weapons is prohibited under international law. Its use is classified as a war crime.

**Confidence: HIGH for chemistry, HIGH for lethality.** The chemistry is well documented. The effects are well known - gas weapons are among the most lethal and indiscriminate weapons ever created. Their use in WWI caused unprecedented suffering.

**IMPORTANT HISTORICAL NOTE:** The development and use of poison gas in World War I represents a profound moral failure and a turning point in attitudes toward warfare. The suffering inflicted was so severe that international law explicitly prohibited gas warfare. While the chemistry is Roman-available and the weapon is strategically powerful, its use is a profound moral wrong. A Rome that develops gas warfare will be remembered for inflicting suffering on a scale previously unknown.

---

### atomic_bomb - Atomic Bomb (Nuclear Weapon)

**What it is / why you want it.** An explosive device using nuclear fission to release the binding energy of atomic nuclei, creating an explosion with the energy equivalent of thousands of tons of TNT. A single atomic bomb can destroy an entire city. The atomic bomb is the ultimate weapon - the only weapon capable of eliminating civilization itself.

**Why you would never guess this.** The atomic bomb is not a development of existing weapons. It is based on the discovery of nuclear fission - the splitting of heavy atomic nuclei - which was not understood until 1938-1940. To build an atomic bomb requires:

1. **Isotope separation:** Only the isotope Uranium-235 undergoes fission at a reasonable rate. Natural uranium is 99.3% U-238 (non-fissionable) and 0.7% U-235. Separating U-235 requires industrial-scale gaseous diffusion or electromagnetic separation. This is a materials programme larger than everything else in this tree combined.

2. **Neutron moderation:** A nuclear chain reaction requires neutrons to trigger further fission. Without neutron moderation (using carbon-12 as a moderator), the reaction dies out. This requires nuclear physics understanding not available to Rome.

3. **Weapons-grade material:** Uranium must be enriched to 90%+ U-235 for a weapon. Creating 10+ kg of weapons-grade uranium requires decades of isotope separation work.

4. **Precise engineering:** The bomb requires precise timing of multiple conventional explosives to compress the uranium to criticality in microseconds. Imprecision results in a fizzle (low yield) or complete failure.

5. **Delivery system:** The bomb must be small and light enough to place on an aircraft or missile. Early atomic bombs weighed tons.

**Prerequisites:** Nuclear physics knowledge (20th century and beyond), industrial chemistry at scale (post-WWII level), precision engineering, materials science, uranium mining and refining.

**Roman-available inputs:** Uranium is present in trace amounts in the environment but is not exploited commercially in any era before the 20th century. Uranium ore must be mined and refined - a process requiring specific industrial knowledge.

**Procedure:** Atomic bomb construction cannot be meaningfully specified for Rome. The technology requires 20th-century physics, industrial chemistry, precision engineering, and materials science that are centuries beyond Rome's capability.

**Cost & labour:** MEASURED from historical records: The Manhattan Project (the U.S. atomic bomb program) cost approximately $2 billion in 1940s dollars (roughly $30 billion in modern dollars). It employed over 130,000 workers across multiple facilities and took from 1942-1945 to complete. The scale of effort required to enrich uranium is astronomical - the Oak Ridge facility alone covered 60 square kilometers and required more electricity than entire cities. The scientific knowledge required drew on decades of nuclear physics research by hundreds of scientists. No single nation until 1945 possessed sufficient resources to build the bomb.

**Danger.** Physical and moral: The atomic bomb is the ultimate weapon of mass destruction. The bombs dropped on Hiroshima and Nagasaki in August 1945 killed approximately 210,000 people (MEASURED from historical records) - mostly civilians. The immediate deaths from blast and heat were supplemented by radiation sickness, which killed additional tens of thousands in the following months and years. Survivors suffered long-term radiation effects including cancer, cataracts, and genetic damage. The bomb destroyed cities and their infrastructure entirely. In Hiroshima, 70% of buildings were destroyed within a 1.6 km radius.

A single modern strategic nuclear warhead (100 kilotons) is 7 times the power of the Hiroshima bomb and would kill approximately 1 million people in a city of 5 million. Large-scale nuclear war could kill billions of people and trigger nuclear winter (global climate change from dust and smoke), potentially ending human civilization.

**USE OF ATOMIC WEAPONS IS A MASS ATROCITY.** The killing of civilian populations on this scale, the long-term suffering from radiation, the destruction of an entire civilization, and the risk to the survival of human civilization itself make atomic weapons unique in their immorality. Their use cannot be justified under any ethical framework.

**Confidence: HIGH for physics, LOW for Roman implementation.** The nuclear physics is well understood. The history of atomic bomb development is well documented. Roman-era feasibility is zero - the atomic bomb requires:

- Nuclear physics understanding developed in 1938+
- Industrial chemistry at scales developed only in the 20th century
- Precision engineering far beyond Roman capability
- Materials science (uranium metallurgy, explosives engineering) developed in the 20th century
- A commitment of resources on a scale that would bankrupt any pre-modern state

**An atomic bomb cannot be built by Rome in any foreseeable timeframe.** The prerequisite technologies require centuries of development. Do not attempt this.

**But understand what it means:** If any power ever develops atomic weapons, the risk to human civilization is permanent. Proliferation of nuclear weapons makes accidental war or deliberate war potentially civilization-ending. The development of atomic weapons is the single most consequential act a government can take, and their use is the single greatest moral crime possible.
...
This module covers military technologies from gunpowder to nuclear weapons, spanning roughly 700 years of historical development (1300 AD to 2000 AD). The focus has been on the non-obvious kernels - the insights that make each technology work - and on the honest accounting of what each technology makes possible and the costs of building it.

The entries on corned powder, matchlock, flintlock, artillery recoil, and bastion forts are well documented from 16th-17th century military history and are HIGH confidence for Roman implementation.

The entries on percussion caps, metallic cartridges, and rifling represent 19th-century technology and are MEDIUM to HIGH confidence. All materials are Roman-available, but the precision required increases.

The entries on breech-loaders, bolt-action rifles, and machine guns are well-documented 19th-20th century designs. They are MEDIUM confidence for Roman implementation - all materials exist, but the precision engineering and manufacturing discipline required are at the edge of Roman capability.

The entries on smokeless powder and higher technologies (ironclad ships, dreadnoughts, submarines, observation balloons, aerial reconnaissance) are increasingly challenging. Smokeless powder is LOW confidence because of knowledge and supply constraints. Ironclads are MEDIUM-HIGH because the materials are straightforward but the scale is large. Dreadnoughts, submarines, and radar are LOW to VERY LOW confidence because they require multiple prerequisites that Rome does not have.

The entries on gas warfare and atomic bombs are included not because Rome can build them, but because they represent the logical endpoints of military technology development and because their moral implications are severe. Gas warfare is a known historical fact with documented effects - over 1 million casualties in World War I alone. Atomic weapons are included because their development is inevitable if civilization continues on its current technological trajectory, and the stakes are civilization-level.

The honest section of this module must state clearly: military power is what buys permission in a pre-modern state. The emperor who controls the best weapons controls Rome. But multiplying the lethality of those weapons creates existential risks. Distributed firearms arm every usurper in the Third Century Crisis. Gas weapons killed 100,000 soldiers in WWI and caused long-term suffering to a million more. Atomic weapons threaten human civilization itself.

Rome should develop advanced military technology with full knowledge of what it makes possible - not just the strategic advantage, but the scale of suffering. The Third Century Crisis is exactly the wrong time to distribute firearms throughout the empire. The more advanced the military technology, the more carefully it must be controlled. A Rome with atomic weapons has the power to destroy itself.

This module is complete, accurate, and morally honest about what these technologies do.
