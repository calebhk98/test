...
The council records why that list is the whole of it, the question having been put this turn and answered, and records that the answer is a decision and not a limit.

The confrontation planners asked for a means of putting explosive on an enemy at a distance from a fixed position, for the Sinai line and the canal approaches. The request was general and named no device, the planners having none to name. The arsenal answered it with what stands. The fortress line's ground is held by water and the sluice gates, its approaches are mined, the incendiary aircraft now reach hundreds of miles beyond the works, and the torsion engines on the walls are as old as the walls and throw what they have always thrown. Trials putting a nitrated charge into a torsion engine were made and stopped, the charge being worth more in a mine that waits under water than in an engine that must be laid, ranged and served in the open while the enemy does whatever he is doing.

No programme was opened, the planners lost the point, and their office keeps its standing. Nothing physical stood in the way and the council will not pretend otherwise. The arc furnace of about 480 to 510 pours steel of higher purity and more controllable carbon than any combustion process, and the western nitrate of Item 10 is the first supply the state has found that does not have to be manufactured, so both of the things that would once have been wanting are in hand. What is wanting is a requirement. Every delivery problem Egypt has actually met has been solved by putting the charge on something that moves, a hull, a boat, a moored case that waits, or an aircraft, because Egypt does not intend to stand and fight a peer on open ground and its whole strategy is built on denying Rome the ground where that happens. A weapon is not built for a battle the state has spent six centuries arranging not to have.
...
The second is higher yields on ground already held, where the new crops rotate against the old and the marginal provinces now feed themselves instead of drawing grain from the Nile. Yields per cultivated acre stand 7 percent above the figure at open. All three quantities are measured across this turn and against the same opening baseline, so that they can be set beside each other: acreage up 14 percent, yield per acre up 7 percent, food output up 22 percent, and population up 15.6 percent from 26.9 million to 31.1 million. The margin of food over mouths is 6.4 points across twenty-five years, and that is what the growth rate is drawn from.

Together they lift growth above the old trend, which is what a ceiling being raised looks like. Population at 550 is 31.1 million against 26.9 million at open, an average of 0.58 percent a year. The opening figure is derived rather than assumed: revenue at open is 142,000 against 132,000 at 500, a rise of 7.6 percent, and the population figure is the same rise off the source's 25.0 million, which gives 26.9 million and an average of 0.294 percent a year across 500 to 525. That interval already runs above the 0.211 percent of 450 to 500, the western stock having arrived about 510 to 515 and the last decade of it catching some effect. The rate then roughly doubles again across this turn once the crops are in provincial cultivation everywhere they suit, which is what a ceiling being raised looks like and is the whole of the difference between the two intervals.
...
| Crop acclimatisation, western and highland | 550 | 600 | Yield per cultivated acre 7 percent above the figure at open, food output 22 percent; highland root crop in cultivation 546. |
